...
class LanguagesRouter: NSObject, LanguagesRoutingLogic, LanguagesDataPassing
{
  ...
  //func navigateToSomewhere(source: LanguagesViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: LanguagesDataStore, destination: inout SomewhereDataStore)
  //{
